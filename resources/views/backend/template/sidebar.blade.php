                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item {{ $role == 'sales' ? 'd-none' : '' }}">
                                <a href="{{ route('lokasi.index') }}"
                                    class="nav-link {{ request()->routeIs('lokasi.index') ? 'active' : '' }}">
                                    <p>Lokasi Part</p>
                                </a>
                            </li>
                        </ul>
                ...
                @if (in_array($role, ['superadmin', 'owner', 'admin', 'gudang']))
                    ...
                    <li class="nav-item">
                        <a href="{{ route('purchase_order.index') }}"
                            class="nav-link {{ request()->routeIs('purchase_order.index') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('barang_masuk.index') }}"
                            class="nav-link {{ request()->routeIs('barang_masuk.index') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('barang_keluar.index') }}"
                            class="nav-link {{ request()->routeIs('barang_keluar.index') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-upload"></i>
                            <p>Barang Keluar</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('barang_broken.index') }}"
                            class="nav-link {{ request()->routeIs('barang_broken.index') ? 'active' : '' }}">
