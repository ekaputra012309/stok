                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="po_number" name="po_number"
                                                placeholder="No Invoice" value="{{ $barangKeluar->po_number }}" readonly
                                                required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="invoice_number"
                                                name="invoice_number" placeholder="No Invoice"
                                                value="{{ $barangKeluar->invoice_number }}" readonly required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_keluar"
                                                id="tanggal_keluar" value="{{ $barangKeluar->tanggal_keluar }}">
                                        </div>
                                            ...
                                            <div class="item-row row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="number" class="form-control qty-input"
                                                        name="items[{{ $index }}][qty]" placeholder="Quantity"
