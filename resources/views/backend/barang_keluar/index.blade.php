                                        ...
                                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill"
                                                    ...
                                                    aria-controls="custom-tabs-four-home" aria-selected="false">Data Barang
                                                    Keluar</a>
                                            </li>
                                            <li class="nav-item">
                                                        ...
                                                        @foreach ($databarang_template as $barangTemplate)
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <button
                                                                        class="btn btn-xs btn-danger delete-btn-template"
                                                                ...
                                                                <td>
                                                                    @php
                                                                        $totalQty = $barangTemplate->details->sum(
                                                                            'qty',
                                                                        );
                                                                        echo $totalQty; // Total quantity of details
                                                                    @endphp
