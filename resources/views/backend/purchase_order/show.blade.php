                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered mt-3">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>{{ number_format($PurchaseOrder->items->sum(fn($item) => $item->qty), 0, ',', '.') }}
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                @if (in_array($role, ['superadmin', 'owner']))
                                    ...
                                    <form action="{{ route('purchase_order.approve', $PurchaseOrder->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <select name="status_order" id="status_order" class="form-control" required>
                                                ...
                                                <option value="Approved"
                                                    {{ $PurchaseOrder->status_order === 'Approved' ? 'selected' : '' }}>
                                                    Approve</option>
                                                <option value="Rejected"
                                                    {{ $PurchaseOrder->status_order === 'Rejected' ? 'selected' : '' }}>Not
                                                    Approve</option>
                                            </select>
                                        </div>

                                        <div class="form-group" id="note-container"
                                            style="{{ $PurchaseOrder->status_order === 'Rejected' ? '' : 'display: none;' }}">
