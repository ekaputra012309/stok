                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @if ($purchaseOrder->status_order === 'Approved')
                                                        <!-- Conditional check for Approved status -->
                                                        <a class="btn btn-xs btn-success"
                                                            href="{{ route('purchase_order.print', $purchaseOrder->id) }}"
                                                            target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    @php
                                                        $totalQty = $purchaseOrder->items->sum('qty');
                                                        $receivedQty = $purchaseOrder->barangMasuk->flatMap->details->sum(
                                                            'qty',
                                                        );
                                                    @endphp
