                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ $role !== 'superadmin' || $role !== 'admin' ? route('barang.index') : route('dashboard') }}"
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('barang_masuk.index') }}" class="small-box-footer">More info <i
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{ route('barang_keluar.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('barang_broken.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="@if ($role == 'superadmin' || $role == 'owner') col-md-12 @else col-md-12 @endif col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <span class="text-danger font-italic font-weight-bold">* Data barang dengan stok limit
                                        *</span>
                                </h3>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($databarang as $brg)
                                            <tr>
                                                <td><strong>({{ $brg->part_number }})</strong> {{ $brg->deskripsi }}</td>
                                                <td>{{ $brg->stok }}</td>
                                                <td>{{ $brg->limit }}</td>
                                                <td>{{ $brg->satuan->name }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    @if (in_array($role, ['superadmin', 'owner']))
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <span class="text-danger font-italic font-weight-bold">* Data PO belum proses!!
                                            *</span>
                                    </h3>
                                    <div class="card-tools">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="btn btn-xs btn-dark"
                                                            href="{{ route('purchase_order.show', $purchaseOrder->id) }}">
