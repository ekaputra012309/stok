                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text"
                                                ...
                                                id="part_number" name="part_number" placeholder="Part Number"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control select2bs4 @error('lokasi_id') is-invalid @enderror"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                                id="stok" name="stok" placeholder="stok" value="0" required>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="limit">Limit</label>
                                            <input type="number" class="form-control @error('limit') is-invalid @enderror"
                                                id="limit" name="limit" placeholder="Limit" value="0" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="satuan_id">UOM</label>
                                            <select class="form-control select2bs4 @error('satuan_id') is-invalid @enderror"
