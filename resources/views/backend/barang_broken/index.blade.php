                                            ...
                                            <tr>
                                                <td>
                                                    <a class="btn btn-xs btn-dark"
                                                        href="{{ route('barang_broken.show', $barangBroken->id) }}">
                                                        <i class="fas fa-eye"></i> Show
                                                    </a> <br>
                                                    <a class="btn btn-xs btn-success"
                                                        href="{{ route('barang_broken.print', $barangBroken->id) }}"
                                                        target="_blank">
                                                        <i class="fas fa-print"></i> Print
                                                    </a> <br>
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('barang_broken.edit', $barangBroken->id) }}">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a> <br>
                                                    <button class="btn btn-xs btn-danger delete-btn"
                                                        data-id="{{ $barangBroken->id }}">
