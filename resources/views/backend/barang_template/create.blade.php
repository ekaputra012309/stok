                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Barang Template</h3>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('nama_template') is-invalid @enderror" id="nama_template" name="nama_template" placeholder="Nama Template" required>
                                        @error('nama_template')
